...
struct qt_meta_stringdata_CLASSWeekViewENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSWeekViewENDCLASS = QtMocHelpers::stringData(
    "WeekView",
    "showPreviousWeek",
    "",
    "showNextWeek",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSWeekViewENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject WeekView::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSWeekViewENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSWeekViewENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSWeekViewENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<WeekView, std::true_type>,
        // method 'showPreviousWeek'
...
void WeekView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->showPreviousWeek(); break;
...
void *WeekView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSWeekViewENDCLASS.stringdata0))
